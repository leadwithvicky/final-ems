  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-400 via-coral-400 to-red-400 p-4">
      <div className="max-w-md w-full">
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl p-8 transform hover:scale-105 transition-transform duration-300">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-100">Visiontech EMS</h2>
            <p className="text-gray-600 dark:text-gray-400 mt-2">Welcome back to your account</p>
          </div>
